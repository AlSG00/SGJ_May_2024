...
public class InteractableRope : InteractableItem, IDroppable
{
    ...
    public static event System.Action<Transform, Vector3, Quaternion> PickingRope;
    ...
    public override void Interact()
    {
        ...
        PickingRope?.Invoke(transform, _inHandPositionOffset, Quaternion.Euler(_inHandRotationOffset));
    }
